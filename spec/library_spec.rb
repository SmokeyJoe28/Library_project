...
describe "Library object" do
  ...
  before :all do
    lib_obj = [
          Book.new("JavaScript: The good", "Doug", :development),
          Book.new("Designing wiht web standards", "Jeff", :design),
          Book.new("Don't make me think", "Steve", :usability),
          Book.new("JavaScript Patterns", "Stoyan", :development),
          Book.new("Responsive Web Design", "Ethan", :design),
    ]
